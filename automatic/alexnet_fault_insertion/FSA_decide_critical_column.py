...
sub_file = "FSA_SA64_random_fault.v" #file name
...
stuckat_fault_file = "sa_fault_info/FSA_proposed_stuckat_fault.txt"
...
with open(stuckat_fault_path,'w')as fk:#寫入剩下的錯誤座標
